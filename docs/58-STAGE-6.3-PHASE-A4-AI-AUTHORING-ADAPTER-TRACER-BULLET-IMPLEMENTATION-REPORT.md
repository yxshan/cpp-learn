...
Remaining work includes controlled summary updates, Reference Example proposals,
bundle-template generation, and a provider-neutral run orchestrator that can
